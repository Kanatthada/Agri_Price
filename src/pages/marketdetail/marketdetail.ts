...
export class MarketdetailPage {
  ...
  constructor(public viewCtrl: ViewController, public navCtrl: NavController, public navParams: NavParams, public datas: MarketDataProvider, public popoverCtrl: PopoverController, public geolocation: Geolocation, private loadingCtrl: LoadingController) {
